    ...
    IncomeVaultInvariantStorage
{
     ...
     */
    function __IncomeVaultValidation_init_unchained(IRuleEngine ruleEngine_) internal onlyInitializing {
     ...
     */
    function setRuleEngine(IRuleEngine ruleEngine_) public virtual onlyRuleEngineManager {
    ...
    function _validateTransfer(address from, address to, uint256 value)
        ...
        view
        virtual
        override(IncomeVaultValidationCore)
    {
