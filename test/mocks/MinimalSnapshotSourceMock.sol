...
contract MinimalSnapshotSourceMock is ISnapshotSource {
    ...
    function snapshotInfo(uint256, address)
        external pure override returns (uint256 tokenHolderBalance, uint256 totalSupply)
    {
    ...
    function snapshotInfoBatch(uint256, address[] calldata addresses)
        external pure override returns (uint256[] memory tokenHolderBalances, uint256 totalSupply)
    {
    ...
    function snapshotInfoBatch(uint256[] calldata times, address[] calldata addresses)
        external pure override returns (uint256[][] memory tokenHolderBalances, uint256[] memory totalSupplies)
    {
