...
| `doc/solidityAPI/index.md` | Generated Solidity API. Refresh with `npx hardhat docgen`; it writes in place. Do **not** add a `@return` naming the `$` storage accessor variable — docgen aborts on it (D-2) |
